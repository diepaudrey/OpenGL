...
int main([[maybe_unused]]int argc, [[maybe_unused]]char* argv[])
{
    ...
    FilePath applicationPath("/home/audrey/Documents/IMAC/S4/openGL/glimac-glfw/TP3_exo2");
    Program program = loadProgram(applicationPath.dirPath() + "TP3_exo2/shaders/triangle.vs.glsl",
                              applicationPath.dirPath() + "TP3_exo2/shaders/triangle.fs.glsl");
    program.use();
